...
def get_obs_serie(wmo_code: str,
    ...
    Args:
        ...
        output_var (str): model ouput var to verify
    ...
    try:
        obs_var = list(obs_vars[model][output_var][obs_source].keys())[0]
    except KeyError:
    ...
    if obs_source=='DDB_obs':
        ...
        obs_var_serie = (obs_var_serie * obs_vars[model][output_var][obs_source][obs_var]['conv'][0]
